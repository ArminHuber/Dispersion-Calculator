...
## Download and usage
There are two ways of how to use DC. In the `Releases` section on the right, click on `Dispersion Calculator v3.0`. Here you can download `DC_v30_Installer.exe` to install DC as a stand-alone or download `Source code` to use the code in MATLAB.
