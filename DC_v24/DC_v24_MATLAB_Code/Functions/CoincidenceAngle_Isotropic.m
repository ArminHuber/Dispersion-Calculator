...
% =========================================================================
function CoincidenceAngle_Isotropic(Crop,FluidLoading,Fluid,HigherOrderModes,PNGresolution,Couplant,S0ModeLabelX,SH0ModeLabelX,A0ModeLabelX,LambModes,ShearHorizontalModes,ScholteModes,SColor,AColor,ALamb,AShear,AScholte,SymmetricModes,AntisymmetricModes,BoxLineWidth,Directory,Export,FontSizeAxes,FontSizeAxesLabels,FontSizeHeadLine,FontSizeModeLabels,HeadLine,LineWidth,Material,ModeLabels,PDF,FileName,Thickness,PNG,SLamb,SShear,SScholte,XAxis,XAxisMode,YAxis) 
%#ok<*FXUP>
%#ok<*AGROW>
%#ok<*CHAIN>
