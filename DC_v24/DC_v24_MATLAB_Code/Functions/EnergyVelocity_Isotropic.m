...
if  LambModes && SymmetricModes && ~isempty(SLamb{1})
    ...
    if  ModeLabels
        ...
        elseif XAxisMode == 3
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SLamb{1}(z(1),5)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
...
if  LambModes && AntisymmetricModes && ~isempty(ALamb{1})
    ...
    if  ModeLabels
        ...
        elseif XAxisMode == 3
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,ALamb{1}(z(1),5)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
...
if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
    ...
    if  ModeLabels
        ...
        elseif XAxisMode == 3
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SShear{1}(z(1),5)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
