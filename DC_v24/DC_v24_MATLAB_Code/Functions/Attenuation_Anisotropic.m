...
if  Symmetric
    if  ~Decoupled
        if  SymmetricModes && ~isempty(S{1})
            if  XAxisMode == 3
                s = plot(S{1}(:,XAxisMode),S{1}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',SColor);
            else
                s = plot(S{1}(:,XAxisMode),S{1}(:,7),'LineWidth',LineWidth,'Color',SColor);
            end
            if  ModeLabels
                z = find(abs(S{1}(:,1)-(ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(S{1}(:,1)-(ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),S{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  XAxisMode == 3
                s(2) = plot(S{2}(:,XAxisMode),S{2}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',SColor);
            else
                s(2) = plot(S{2}(:,XAxisMode),S{2}(:,7),'LineWidth',LineWidth,'Color',SColor);
            end
            if  ModeLabels
                z = find(abs(S{2}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(S{2}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),S{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 3:size(S,2)
                    if  XAxisMode == 3
                        s(i) = plot(S{i}(:,XAxisMode),S{i}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',SColor);
                    else
                        s(i) = plot(S{i}(:,XAxisMode),S{i}(:,7),'LineWidth',LineWidth,'Color',SColor);
                    end
                end
            end
        end
        if  AntisymmetricModes && ~isempty(A{1})
            if  XAxisMode == 3
                a = plot(A{1}(:,XAxisMode),A{1}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',AColor);
            else
                a = plot(A{1}(:,XAxisMode),A{1}(:,7),'LineWidth',LineWidth,'Color',AColor);                
            end
            if  ModeLabels
                z = find(abs(A{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(A{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),A{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,A{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,A{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 2:size(A,2)
                    if  XAxisMode == 3
                        a(i) = plot(A{i}(:,XAxisMode),A{i}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',AColor);
                    else
                        a(i) = plot(A{i}(:,XAxisMode),A{i}(:,7),'LineWidth',LineWidth,'Color',AColor);
                    end
                end
            end
        end
        ...
        if  LambModes && SymmetricModes && ~isempty(SLamb{1})
            if  XAxisMode == 3
                sLamb = plot(SLamb{1}(:,XAxisMode),SLamb{1}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',SColor);
            else
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),SLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,SLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 2:size(SLamb,2)
                    if  XAxisMode == 3
                        sLamb(i) = plot(SLamb{i}(:,XAxisMode),SLamb{i}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',SColor);
                    else
        ...
        if  LambModes && AntisymmetricModes && ~isempty(ALamb{1})
            if  XAxisMode == 3
                aLamb = plot(ALamb{1}(:,XAxisMode),ALamb{1}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',AColor);
            else
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),ALamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,ALamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,ALamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 2:size(ALamb,2)
                    if  XAxisMode == 3
                        aLamb(i) = plot(ALamb{i}(:,XAxisMode),ALamb{i}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',AColor);
                    else
        ...
        if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
            if  XAxisMode == 3
                sShear = plot(SShear{1}(:,XAxisMode),SShear{1}(:,6)*PlateThickness*1e3,'LineStyle','--','LineWidth',LineWidth,'Color',SColor);
            else
            ...
            if  HigherOrderModes
                for i = 2:size(SShear,2)
                    if  XAxisMode == 3
                        sShear(i) = plot(SShear{i}(:,XAxisMode),SShear{i}(:,6)*PlateThickness*1e3,'LineStyle','--','LineWidth',LineWidth,'Color',SColor);
                    else
        ...
        if  ShearHorizontalModes && AntisymmetricModes && HigherOrderModes && ~isempty(AShear{1})
            for i = 1:size(AShear,2)
                if  XAxisMode == 3
                    aShear(i) = plot(AShear{i}(:,XAxisMode),AShear{i}(:,6)*PlateThickness*1e3,'LineStyle','--','LineWidth',LineWidth,'Color',AColor);
                else
        ...
        if  ScholteModes && SymmetricModes && ~isempty(SScholte{1})
            if  XAxisMode == 3
                sScholte = plot(SScholte{1}(:,XAxisMode),SScholte{1}(:,6)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',SColor);
            else
            ...
            if  HigherOrderModes
                for i = 2:size(SScholte,2)
                    if  XAxisMode == 3
                        sScholte(i) = plot(SScholte{i}(:,XAxisMode),SScholte{i}(:,6)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',SColor);
                    else
        ...
        if  ScholteModes && AntisymmetricModes && ~isempty(AScholte{1})
            if  XAxisMode == 3
                aScholte = plot(AScholte{1}(:,XAxisMode),AScholte{1}(:,6)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',AColor);
            else
            ...
            if  HigherOrderModes
                for i = 2:size(AScholte,2)
                    if  XAxisMode == 3
                        aScholte(i) = plot(AScholte{i}(:,XAxisMode),AScholte{i}(:,6)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',AColor);
                    else
    ...
    if  ~Decoupled
        if  ~isempty(B{1})
            if  XAxisMode == 3
                b = plot(B{1}(:,XAxisMode),B{1}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
            else
                b = plot(B{1}(:,XAxisMode),B{1}(:,7),'LineWidth',LineWidth,'Color',BColor);
            end 
            if  ModeLabels
                z = find(abs(B{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(B{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),B{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{1}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  XAxisMode == 3
                b(2) = plot(B{2}(:,XAxisMode),B{2}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
            else
                b(2) = plot(B{2}(:,XAxisMode),B{2}(:,7),'LineWidth',LineWidth,'Color',BColor);
            end  
            if  ModeLabels
                z = find(abs(B{2}(:,1)-(ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(B{2}(:,1)-(ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),B{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{2}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  XAxisMode == 3
                b(3) = plot(B{3}(:,XAxisMode),B{3}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
            else
                b(3) = plot(B{3}(:,XAxisMode),B{3}(:,7),'LineWidth',LineWidth,'Color',BColor);
            end 
            if  ModeLabels
                z = find(abs(B{3}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(B{3}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),B{3}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{3}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{3}(z(1),7)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 4:size(B,2)
                    if  XAxisMode == 3
                        b(i) = plot(B{i}(:,XAxisMode),B{i}(:,7)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
                    else
                        b(i) = plot(B{i}(:,XAxisMode),B{i}(:,7),'LineWidth',LineWidth,'Color',BColor);
                    end 
                end
            end
        end
        if  ScholteModes && ~isempty(BScholte{1})
            for i = 1:length(BScholte)
                if  XAxisMode == 3
                    bScholte(i) = plot(BScholte{i}(:,XAxisMode),BScholte{i}(:,7)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',BColor);
                else
                    bScholte(i) = plot(BScholte{i}(:,XAxisMode),BScholte{i}(:,7),'LineStyle','-.','LineWidth',LineWidth,'Color',BColor);
                end
            end
        end        
    else
        if  LambModes
            if  XAxisMode == 3
                bLamb = plot(BLamb{1}(:,XAxisMode),BLamb{1}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
            else
                bLamb = plot(BLamb{1}(:,XAxisMode),BLamb{1}(:,6),'LineWidth',LineWidth,'Color',BColor);
            end 
            if  ModeLabels
                z = find(abs(BLamb{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(BLamb{1}(:,1)-(ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),BLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  XAxisMode == 3
                bLamb(2) = plot(BLamb{2}(:,XAxisMode),BLamb{2}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
            else
                bLamb(2) = plot(BLamb{2}(:,XAxisMode),BLamb{2}(:,6),'LineWidth',LineWidth,'Color',BColor);
            end 
            if  ModeLabels
                z = find(abs(BLamb{2}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))) == min(abs(BLamb{2}(:,1)-(ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)))));
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),BLamb{2}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BLamb{2}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BLamb{2}(z(1),6)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 3:size(BLamb,2)
                    if  XAxisMode == 3
                        bLamb(i) = plot(BLamb{i}(:,XAxisMode),BLamb{i}(:,6)*PlateThickness*1e3,'LineWidth',LineWidth,'Color',BColor);
                    else
                        bLamb(i) = plot(BLamb{i}(:,XAxisMode),BLamb{i}(:,6),'LineWidth',LineWidth,'Color',BColor);
                    end 
                end
            end
        end
        if  ShearHorizontalModes
            if  SuperLayerSize > 1 && ~SymmetricSystem
                if  XAxisMode == 3
                    bShear = plot(BShear{1}(:,XAxisMode),BShear{1}(:,6)*PlateThickness*1e3,'LineStyle','--','LineWidth',LineWidth,'Color',BColor);
                else
                    bShear = plot(BShear{1}(:,XAxisMode),BShear{1}(:,6),'LineStyle','--','LineWidth',LineWidth,'Color',BColor);
                end 
                if  HigherOrderModes
                    for i = 2:size(BShear,2)
                        if  XAxisMode == 3
                            bShear(i) = plot(BShear{i}(:,XAxisMode),BShear{i}(:,6)*PlateThickness*1e3,'LineStyle','--','LineWidth',LineWidth,'Color',BColor);
                        else
                            bShear(i) = plot(BShear{i}(:,XAxisMode),BShear{i}(:,6),'LineStyle','--','LineWidth',LineWidth,'Color',BColor);
                        end 
                    end
                end
        ...
        if  ScholteModes && ~isempty(BScholte{1})
            for i = 1:length(BScholte)
                if  XAxisMode == 3
                    bScholte(i) = plot(BScholte{i}(:,XAxisMode),BScholte{i}(:,6)*PlateThickness*1e3,'LineStyle','-.','LineWidth',LineWidth,'Color',BColor);
                else
                    bScholte(i) = plot(BScholte{i}(:,XAxisMode),BScholte{i}(:,6),'LineStyle','-.','LineWidth',LineWidth,'Color',BColor);
                end
            end
        end
    end
...
function output_txt = Cursor(~,event_obj)
    if  Symmetric
        if  ~Decoupled
            if  ~isempty(S{1}) && all(event_obj.Target.Color == SColor)
                for i = 1:length(S)
                    if  i == 1 && event_obj.Target.YData(1) == S{1}(1,7)
                        ModeName = 'S$_0$';
                        break
                    elseif i == 2 && event_obj.Target.YData(1) == S{2}(1,7)
                        ModeName = 'S$_1$';
                        break
        ...
        if  ~Decoupled
            if  ~isempty(B{1})
                for i = 1:length(B)
                    if  i == 1 && event_obj.Target.YData(1) == B{1}(1,7)
                        ModeName = 'B$_0$';
                        break 
                    elseif i == 2 && event_obj.Target.YData(1) == B{2}(1,7)
                        ModeName = 'B$_1$';
                        break
                    elseif i == 3 && event_obj.Target.YData(1) == B{3}(1,7)
                        ModeName = 'B$_2$';
                        break
        ...
        if  ~isempty(BScholte{1}) && all(event_obj.Target.Color == BColor) && strcmp(event_obj.Target.LineStyle,'-.')
            for i = 1:length(BScholte)
                if  i == 1 && (event_obj.Target.YData(1) == BScholte{1}(1,6) || event_obj.Target.YData(1) == BScholte{1}(1,7))
                    ModeName = 'B$^{\mathrm{Scholte}}_0$';
                    break
                elseif i == 2 && (event_obj.Target.YData(1) == BScholte{2}(1,6) || event_obj.Target.YData(1) == BScholte{2}(1,7))
    ...
    elseif XAxisMode == 3 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f\cdot d$: \textbf{',num2str(event_obj.Position(1),6),'} MHz$\cdot$mm'] ['$\alpha\cdot d$: \textbf{',num2str(event_obj.Position(2),6),'} Np$\cdot$mm/m']};
