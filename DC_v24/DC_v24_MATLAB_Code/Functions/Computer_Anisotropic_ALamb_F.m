...
% =========================================================================
function ALamb = Computer_Anisotropic_ALamb_F(Multithreading,Q1,Q2,ax,Viscoelastic,FluidLoading,Fluid,FluidDensityThreshold,Material,Hybrid,FrequencyRange,PlateThickness,HigherOrderModes,FLambF,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset)
...
if  HigherOrderModes && any(H)
    ...
    for p = 1:length(H)
        if  ~Multithreading
            [ALamb,X1,MissingModes] = Computer_Anisotropic_ALamb_F_HigherModes(Multithreading,Q1,Q2,FluidLoading,Fluid,Material,FrequencyRange,PlateThickness,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset,ALamb,X1,A1,MissingModes,X0,T,p,g,g1,a21,a22,a31,a32);
            clear Computer_Anisotropic_ALamb_F_HigherModes
        else
            X = [];
            Misses = 0;
            BelowCutoff = 0;       
