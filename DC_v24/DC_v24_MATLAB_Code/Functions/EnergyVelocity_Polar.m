...
elseif HeadLine == 1
    ...
    if  Mode == 1
        ax.Title.String = ['Energy velocity $c_{\mathrm e1}$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' @ ',num2str(Frequency),'\,kHz'];
    elseif Mode == 2
        ax.Title.String = ['Energy velocity $|\vec{c}_{\mathrm e}|$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' @ ',num2str(Frequency),'\,kHz'];
    elseif Mode == 3
        ax.Title.String = ['Skew angle in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' @ ',num2str(Frequency),'\,kHz'];
    end 
elseif SymmetricSystem == 0 && HeadLine == 2
    ax.Title.FontSize = FontSizeHeadLine;
    if  Repetitions == 1
        if  Mode == 1
            ax.Title.String = ['Energy velocity $c_{\mathrm e1}$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,'] @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 2
            ax.Title.String = ['Energy velocity $|\vec{c}_{\mathrm e}|$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,'] @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 3
            ax.Title.String = ['Skew angle in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,'] @ ',num2str(Frequency),'\,kHz'];
        end     
    elseif Repetitions > 1
        if  Mode == 1
            ax.Title.String = ['Energy velocity $c_{\mathrm e1}$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 2
            ax.Title.String = ['Energy velocity $|\vec{c}_{\mathrm e}|$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 3
            ax.Title.String = ['Skew angle in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'}$ @ ',num2str(Frequency),'\,kHz'];
        end    
    end
elseif SymmetricSystem == 1 && HeadLine == 2
    ...
    if  Repetitions == 1
        if  Mode == 1
            ax.Title.String = ['Energy velocity $c_{\mathrm e1}$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 2
            ax.Title.String = ['Energy velocity $|\vec{c}_{\mathrm e}|$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 3
            ax.Title.String = ['Skew angle in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        end     
    elseif Repetitions > 1
        if  Mode == 1
            ax.Title.String = ['Energy velocity $c_{\mathrm e1}$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 2
            ax.Title.String = ['Energy velocity $|\vec{c}_{\mathrm e}|$ in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        elseif Mode == 3
            ax.Title.String = ['Skew angle in ',num2str(PlateThickness*1e3),'\,mm ',char(join(split(Material{1}.Name,'_'),'\_')),' [',LayupString,']$_{',num2str(Repetitions),'\mathrm s}$ @ ',num2str(Frequency),'\,kHz'];
        end    
    end
end
z = ax.RTick;
    ...
    try
        if  PDF == 1
            if  Crop == 0
                ...
                elseif Mode == 2
                    print(f,fullfile(Directory,[FileName,'_ceAbs']),'-dpdf')
                elseif Mode == 3
                    print(f,fullfile(Directory,[FileName,'_ceSkew']),'-dpdf')
                end
            elseif Crop == 1
                if  Mode == 1
                    exportgraphics(f,fullfile(Directory,[FileName,'_ce1.pdf']))
                elseif Mode == 2
                    exportgraphics(f,fullfile(Directory,[FileName,'_ceAbs.pdf']))
                elseif Mode == 3
                    exportgraphics(f,fullfile(Directory,[FileName,'_ceSkew.pdf']))
                end
            end
        end
        if  PNG == 1
            if  Crop == 0
                ...
                elseif Mode == 2
                    print(f,fullfile(Directory,[FileName,'_ceAbs']),'-dpng',['-r',num2str(PNGresolution)])
                elseif Mode == 3
                    print(f,fullfile(Directory,[FileName,'_ceSkew']),'-dpng',['-r',num2str(PNGresolution)])    
                end
            elseif Crop == 1
                if  Mode == 1
