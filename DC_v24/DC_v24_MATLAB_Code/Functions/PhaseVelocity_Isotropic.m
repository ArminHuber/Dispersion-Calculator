...
if  LambModes && SymmetricModes && ~isempty(SLamb{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes 
...
if  LambModes && AntisymmetricModes && ~isempty(ALamb{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
...
if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
...
if  BulkVelocities
    ...
    if  FluidLoading
        plot(XAxis,[Fluid.Velocity Fluid.Velocity]/1e3,'LineWidth',LineWidth,'Color','c');
    end
    if  ModeLabels
        if  XAxisMode == 1
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1)),Material.LongitudinalVelocity/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1)),Material.TransverseVelocity/1e3+(YAxis(2)-YAxis(1))/30,'T','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                text((.02*(XAxis(2)-XAxis(1))+XAxis(1)),Fluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(Fluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
            end
        elseif XAxisMode == 2
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,Material.LongitudinalVelocity/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,Material.TransverseVelocity/1e3+(YAxis(2)-YAxis(1))/30,'T','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                text((.02*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,Fluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(Fluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
            end
        elseif XAxisMode == 3
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,Material.LongitudinalVelocity/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,Material.TransverseVelocity/1e3+(YAxis(2)-YAxis(1))/30,'T','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                text((.02*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,Fluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(Fluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
            end
        end
    end
end
...
function output_txt = Cursor(~,event_obj)
    ...
    elseif all(event_obj.Target.Color == [0 1 1]) && event_obj.Target.YData(1) == Fluid.Velocity/1e3
        output_txt = {['\textbf{',char(join(split(Fluid.Name,'_'),'\_')),'}'] ['$v$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
