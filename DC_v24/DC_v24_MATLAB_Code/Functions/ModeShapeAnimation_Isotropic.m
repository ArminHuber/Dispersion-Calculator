...
% =========================================================================
function ModeShapeAnimation_Isotropic(Directory,FluidLoading,Fluid,FontSizeHeadLine,FontSizeAxesLabels,FrameRate,Frequency,GridLine,HeadLine,LineWidth,Material,Mode,Movie,FileName,MovieQuality,Thickness,SamplesX1,SamplesX3,Scale,Time,u,Undistorted,x1,x3,p,ShowHalfSpaces,HalfSpaces)
%#ok<*AGROW>
...
if  HeadLine
    ...
    String = [ModeName,' @ ',num2str(Frequency),'\,kHz in ',num2str(Thickness),'\,mm ',char(join(split(Material.Name,'_'),'\_'))];
    if  FluidLoading
