...
% =========================================================================
function SnellsLaw3D_Anisotropic(Crop,FontSizeModeLabels,Solid,FontSizeAxesLabels,BoxLineWidth,ViewTheta,ViewPhi,Export,PDF,PNG,FileName,Directory,HeadLine,FontSizeHeadLine,FontSizeAxes,BulkWaves,WaveVectorLineWidth,PNGresolution,Phi,Theta)    
SsArrowTheta = 1;
SsArrowLength = .05;
...
if  HeadLine == 1
    ...
    ax.Title.String = ['Bulk waves generated in ',char(join(split(Solid.Name,'_'),'\_')),' upon plane wave incidence @ $\phi$ = ',num2str(Phi),'\,$^{\circ}$, $\theta$ = ',num2str(Theta),'\,$^{\circ}$'];
end
