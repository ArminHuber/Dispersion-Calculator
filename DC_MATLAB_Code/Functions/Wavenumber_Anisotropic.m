    ...
    if  ~Decoupled
        if  SymmetricModes && ~isempty(S{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),S{1}(z(1),5),'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S{1}(z(1),5),'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S{1}(z(1),5)*(PlateThickness*1e3),'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
        ...
        if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),SShear{1}(z(1),5),'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SShear{1}(z(1),5),'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,SShear{1}(z(1),5)*(PlateThickness*1e3),'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
    ...
    if  ~Decoupled
        if  ~isempty(B{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),B{2}(z(1),5),'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{2}(z(1),5),'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{2}(z(1),5)*(PlateThickness*1e3),'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
        ...
        if  ShearHorizontalModes
            if  SuperLayerSize > 1 && ~SymmetricSystem
                ...
                if  ModeLabels
                    ...
                    if  XAxisMode == 1
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),BShear{1}(z(1),5),'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    elseif XAxisMode == 2
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BShear{1}(z(1),5),'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    elseif XAxisMode == 3
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BShear{1}(z(1),5)*(PlateThickness*1e3),'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    end
                end
                if  HigherOrderModes
...
function output_txt = Cursor(~,event_obj)
    if  Symmetric
        ...
        if  ~Decoupled
            if  ~isempty(B{1})
                for i = 1:length(B)
                    if  i == 1 && (event_obj.Target.YData(1) == B{1}(2,5) || event_obj.Target.YData(1) == B{1}(1,5)*(PlateThickness*1e3))
                        ModeName = 'B$_0$';
                        break 
    ...
    elseif XAxisMode == 3 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f\cdot d$: \textbf{',num2str(event_obj.Position(1),6),'} MHz$\cdot$mm'] ['$\xi\cdot d$: \textbf{',num2str(event_obj.Position(2),6),'} rad']};
