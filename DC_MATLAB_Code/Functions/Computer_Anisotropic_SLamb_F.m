...
% =========================================================================
function SLamb = Computer_Anisotropic_SLamb_F(Multithreading,Q1,Q2,ax,Viscoelastic,FluidLoading,Fluid,FluidDensityThreshold,Material,Hybrid,FrequencyRange,PlateThickness,HigherOrderModes,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset)        
...
if  HigherOrderModes && any(H)
    ...
    for p = 1:length(H)
        if  ~Multithreading
            [SLamb,X1,MissingModes] = Computer_Anisotropic_SLamb_F_HigherModes(Multithreading,Q1,Q2,FluidLoading,Fluid,Material,FrequencyRange,PlateThickness,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset,SLamb,X1,A1,MissingModes,X0,T,p,g,g1,a21,a22,a31,a32);
            clear Computer_Anisotropic_SLamb_F_HigherModes
        else
            X = [];
            Misses = 0;
            BelowCutoff = 0;
