...
% =========================================================================
function SScholte = Computer_Anisotropic_SScholte_Coupled(Multithreading,Q,ax,Fluid,Material,H,FrequencyRange,PhaseVelocityResolution,PhaseVelocitySections,PlateThickness,HigherOrderModes,FrequencyResolution,LambPhaseVelocitySweepRange1,LambPhaseVelocitySweepRange2,c,SuperLayerSize,LayerThicknesses,Repetitions,Delta,MissingSamples,BelowCutoffWidth)        
%#ok<*AGROW>
%#ok<*OR2>
%#ok<*MINV>
%#ok<*GVMIS>
    ...
    for o = 1:PhaseVelocitySections % increase search resolution
        ...
        for k = 1:Bisections % search minimum in characteristic equation and converge upon it
            ...
            for j = 1:length(WaveNumber)
                ...
                Y(j) = abs(MFluid+G(3,1)-G(3,4)*G(6,1)/G(6,4));
            end
