    ...
    if  ~Decoupled
        if  SymmetricModes && ~isempty(S{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),S{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),S{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 3:size(S,2)
        ...
        if  AntisymmetricModes && ~isempty(A{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),A{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,A{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,A{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 2:size(A,2)
        ...
        if  LambModes && SymmetricModes && ~isempty(SLamb{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,SLamb{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
        ...
        if  LambModes && AntisymmetricModes && ~isempty(ALamb{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,ALamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
        ...
        if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,SShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
    ...
    if  ~Decoupled
        if  ~isempty(B{1})
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),B{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),B{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),B{3}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,B{3}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,B{3}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_2$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
                for i = 4:size(B,2)
        ...
        if  LambModes
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1)),BLamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BLamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel3X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BLamb{1}(z(1),4)-(YAxis(2)-YAxis(1))/30,'B$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            ...
            if  ModeLabels
                ...
                if  XAxisMode == 1
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1)),BLamb{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 2
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BLamb{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                elseif XAxisMode == 3
                    text((ModeLabel1X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BLamb{2}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$_1$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
            if  HigherOrderModes
        ...
        if  ShearHorizontalModes
            if  SuperLayerSize > 1 && ~SymmetricSystem
                ...
                if  ModeLabels
                    ...
                    if  XAxisMode == 1
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1)),BShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    elseif XAxisMode == 2
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,BShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    elseif XAxisMode == 3
                        text((ModeLabel2X*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,BShear{1}(z(1),4)+(YAxis(2)-YAxis(1))/30,'B$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
                    end
                end
                if  HigherOrderModes
...
if  SuperLayerSize == 1 && BulkVelocities
    ...
    if  ModeLabels
        if  XAxisMode == 1
            text((.01*(XAxis(2)-XAxis(1))+XAxis(1)),S_fast/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{fast}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.075*(XAxis(2)-XAxis(1))+XAxis(1)),S_slow/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{slow}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1)),L/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                if  Symmetric
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1)),UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                else
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1)),UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1)),LowerFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(LowerFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
        elseif XAxisMode == 2
            text((.01*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S_fast/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{fast}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.075*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,S_slow/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{slow}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,L/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                if  Symmetric
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                else
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,LowerFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(LowerFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
        elseif XAxisMode == 3
            text((.01*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S_fast/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{fast}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.075*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,S_slow/1e3+(YAxis(2)-YAxis(1))/30,'S$_{\mathrm{slow}}$','FontSize',FontSizeModeLabels,'Interpreter','latex');
            text((.02*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,L/1e3+(YAxis(2)-YAxis(1))/30,'L','FontSize',FontSizeModeLabels,'Interpreter','latex');
            if  FluidLoading
                if  Symmetric
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                else
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,UpperFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(UpperFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                    text((.15*(XAxis(2)-XAxis(1))+XAxis(1))*PlateThickness,LowerFluid.Velocity/1e3+(YAxis(2)-YAxis(1))/30,char(join(split(LowerFluid.Name,'_'),'\_')),'FontSize',FontSizeModeLabels,'Interpreter','latex');
                end
            end
        end
    end
...
function output_txt = Cursor(~,event_obj)
    ...
    if  XAxisMode == 1 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f$: \textbf{',num2str(event_obj.Position(1),6),'} kHz'] ['$c_{\mathrm{p}}$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
    elseif XAxisMode == 2 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f$: \textbf{',num2str(event_obj.Position(1),6),'} MHz'] ['$c_{\mathrm{p}}$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
    elseif XAxisMode == 3 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f\cdot d$: \textbf{',num2str(event_obj.Position(1),6),'} MHz$\cdot$mm'] ['$c_{\mathrm{p}}$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
    ...
    elseif all(event_obj.Target.Color == [0 1 1]) && event_obj.Target.YData(1) == UpperFluid.Velocity/1e3
        output_txt = {['\textbf{',char(join(split(UpperFluid.Name,'_'),'\_')),'}'] ['$v$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
    elseif all(event_obj.Target.Color == [0 1 1]) && event_obj.Target.YData(1) == LowerFluid.Velocity/1e3
        output_txt = {['\textbf{',char(join(split(LowerFluid.Name,'_'),'\_')),'}'] ['$v$: \textbf{',num2str(event_obj.Position(2),6),'} m/ms']};
