...
if  ShearHorizontalModes && SymmetricModes && ~isempty(SShear{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),SShear{1}(z(1),5),'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SShear{1}(z(1),5),'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((SH0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SShear{1}(z(1),5)*Thickness,'S$^{\mathrm{SH}}_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
