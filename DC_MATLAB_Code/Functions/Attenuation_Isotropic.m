...
% =========================================================================
function Attenuation_Isotropic(Crop,FluidLoading,Fluid,HigherOrderModes,PNGresolution,S0ModeLabelX,A0ModeLabelX,LambModes,ShearHorizontalModes,ScholteModes,SColor,AColor,ALamb,AShear,AScholte,SymmetricModes,AntisymmetricModes,BoxLineWidth,Directory,Export,FontSizeAxes,FontSizeAxesLabels,FontSizeHeadLine,FontSizeModeLabels,HeadLine,LineWidth,Material,ModeLabels,PDF,FileName,Thickness,PNG,SLamb,SShear,SScholte,XAxis,XAxisMode,YAxis) 
%#ok<*FXUP>
%#ok<*AGROW>
%#ok<*CHAIN>
...
if  LambModes && SymmetricModes && ~isempty(SLamb{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),SLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,SLamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((S0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,SLamb{1}(z(1),6)*Thickness+(YAxis(2)-YAxis(1))/30,'S$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
...
if  LambModes && AntisymmetricModes && ~isempty(ALamb{1})
    ...
    if  ModeLabels
        ...
        if  XAxisMode == 1
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1)),ALamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 2
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))/1e3,ALamb{1}(z(1),6)+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        elseif XAxisMode == 3
            text((A0ModeLabelX*(XAxis(2)-XAxis(1))+XAxis(1))*Thickness/1e3,ALamb{1}(z(1),6)*Thickness+(YAxis(2)-YAxis(1))/30,'A$_0$','FontSize',FontSizeModeLabels,'Interpreter','latex');
        end
    end
    if  HigherOrderModes
