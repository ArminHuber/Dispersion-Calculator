...
if  Status == 0
    if  ~a.MultiMode3
        ...
        h2.YAxis(1).Label.String  = 'Amplitude';
...
elseif Status == 1
    ...
    if  ~a.MultiMode3
        ...
        h2.YLabel.FontSize = 10;
        yyaxis(h2,'left')
        line(a.ExcitationSignal3(1,:)*1e6,a.ExcitationSignal3(2,:),'LineWidth',.5,'Color','r')
        xline(a.Gate3(1))
        xline(a.Gate3(2))
        yyaxis(h2,'right')
        line(a.PlotXAxis3,a.uSum3{1}*1e9,'LineWidth',.5,'Color','b')
        ...
        h3 = axes('Parent',Tab3,'Units','pixels','Position',[340 230 400 230]);
        hold on
        line(a.FrequencyRange3,a.ExcitationMagnitude3,'LineWidth',.5,'Color','r')
        h3.Box = 'on';
        h3.TitleFontWeight = 'normal';
        h3.Title.String = 'Excitation spectrum';
        h3.XLabel.String = 'Frequency (kHz)';
        ...
        h4 = axes('Parent',Tab3,'Units','pixels','Position',[740 230 400 230]);
        hold on
        line(a.FrequencyRange3,PropagatedMagnitude*1e9,'LineWidth',.5,'Color','b')
        h4.Box = 'on';
        h4.TitleFontWeight = 'normal';
        h4.Title.String = 'Propagated spectrum'; 
        h4.XLabel.String = 'Frequency (kHz)';
        ...
        if  a.DataType3 == 1
            ...
            if  any(~cellfun(@isempty,a.uSumALamb3))
                for p = 1:length(a.PhaseVelocityALamb3)
            ...
            if  any(~cellfun(@isempty,a.uSumSLamb3))
                for p = 1:length(a.PhaseVelocitySLamb3)
            ...
            if  any(~cellfun(@isempty,a.uSumAShear3))
                for p = 1:length(a.PhaseVelocityAShear3)
            ...
            if  any(~cellfun(@isempty,a.uSumSShear3))
                for p = 1:length(a.PhaseVelocitySShear3)
        ...
        elseif a.DataType3 == 2
            if  a.Symmetric
                if  ~a.Decoupled
                    uSUMA = 0;
                    uSUMS = 0;
                    if  any(~cellfun(@isempty,a.uSumA3))
                        for p = 1:length(a.PhaseVelocityA3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumA3{p})
                                uSUMA = uSUMA+a.Amplitude_ALamb3(p)*a.uSumA3{p};
                            end
                        end
                        uSUM = uSUMA;
                    end
                    if  any(~cellfun(@isempty,a.uSumS3))
                        for p = 1:length(a.PhaseVelocityS3)
                            if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumS3{p})
                                uSUMS = uSUMS+a.Amplitude_SLamb3(p)*a.uSumS3{p};
                            end
                        end
                        uSUM = uSUM+uSUMS;
                    end
                ...
                if  ~a.Decoupled
                    uSUMB = 0;
                    if  any(~cellfun(@isempty,a.uSumB3))
                        for p = 1:length(a.PhaseVelocityB3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumB3{p})
                                uSUMB = uSUMB+a.Amplitude_ALamb3(p)*a.uSumB3{p};
                            end
                        end
                        uSUM = uSUMB;
                    end                    
                    ...
                    if  any(~cellfun(@isempty,a.uSumBLamb3))
                        for p = 1:length(a.PhaseVelocityBLamb3)
                    ...
                    if  any(~cellfun(@isempty,a.uSumBShear3))
                        for p = 1:length(a.PhaseVelocityBShear3)
        ...
        if  a.DataType3 == 1
            if  any(~cellfun(@isempty,a.uSumALamb3))
                for p = 1:length(a.PhaseVelocityALamb3)
                    if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumALamb3{p})
                        ...
                        line(a.PlotXAxis3,a.Amplitude_ALamb3(p)*1e9*a.uSumALamb3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
            ...
            if  any(~cellfun(@isempty,a.uSumSLamb3))
                for p = 1:length(a.PhaseVelocitySLamb3)
                    if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumSLamb3{p})
                        LineColorsIndex = LineColorsIndex+1;
                        line(a.PlotXAxis3,a.Amplitude_SLamb3(p)*1e9*a.uSumSLamb3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
            ...
            if  any(~cellfun(@isempty,a.uSumAShear3))
                for p = 1:length(a.PhaseVelocityAShear3)
                    if  a.Plot_AShear3(p) == 1 && ~isempty(a.uSumAShear3{p})
                        LineColorsIndex = LineColorsIndex+1;
                        line(a.PlotXAxis3,a.Amplitude_AShear3(p)*1e9*a.uSumAShear3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
            ...
            if  any(~cellfun(@isempty,a.uSumSShear3))
                for p = 1:length(a.PhaseVelocitySShear3)
                    if  a.Plot_SShear3(p) == 1 && ~isempty(a.uSumSShear3{p})
                        LineColorsIndex = LineColorsIndex+1;
                        line(a.PlotXAxis3,a.Amplitude_SShear3(p)*1e9*a.uSumSShear3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
                ...
                if  ~a.Decoupled
                    if  any(~cellfun(@isempty,a.uSumA3))  
                        for p = 1:length(a.PhaseVelocityA3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumA3{p})
                                LineColorsIndex = LineColorsIndex+1;
                                line(a.PlotXAxis3,a.Amplitude_ALamb3(p)*1e9*a.uSumA3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
                                ModeNames{end+1} = {['A$_',num2str(p-1),'$']};
                                ModeColors(end+1,:) = a.LineColors3(LineColorsIndex,:);
                                if  LineColorsIndex == length(a.LineColors3)
                                    LineColorsIndex = 0;
                    ...
                    if  any(~cellfun(@isempty,a.uSumS3))
                        for p = 1:length(a.PhaseVelocityS3) 
                            if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumS3{p})
                                LineColorsIndex = LineColorsIndex+1;
                                line(a.PlotXAxis3,a.Amplitude_SLamb3(p)*1e9*a.uSumS3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
                                ModeNames{end+1} = {['S$_',num2str(p-1),'$']};
                                ModeColors(end+1,:) = a.LineColors3(LineColorsIndex,:); 
                                if  LineColorsIndex == length(a.LineColors3)
                                    LineColorsIndex = 0;
                ...
                if  ~a.Decoupled
                    if  any(~cellfun(@isempty,a.uSumB3))
                        for p = 1:length(a.PhaseVelocityB3) 
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumB3{p})
                                LineColorsIndex = LineColorsIndex+1;
                                line(a.PlotXAxis3,a.Amplitude_ALamb3(p)*1e9*a.uSumB3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
                    ...
                    if  any(~cellfun(@isempty,a.uSumBLamb3))
                        for p = 1:length(a.PhaseVelocityBLamb3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumBLamb3{p})
                                LineColorsIndex = LineColorsIndex+1;
                                line(a.PlotXAxis3,a.Amplitude_ALamb3(p)*1e9*a.uSumBLamb3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
                                ModeNames{end+1} = {['B$_',num2str(p-1),'$']};
                                ModeColors(end+1,:) = a.LineColors3(LineColorsIndex,:); 
                                if  LineColorsIndex == length(a.LineColors3)
                                    LineColorsIndex = 0;
                    ...
                    if  any(~cellfun(@isempty,a.uSumBShear3))
                        for p = 1:length(a.PhaseVelocityBShear3)
                            if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumBShear3{p})
                                LineColorsIndex = LineColorsIndex+1;
                                line(a.PlotXAxis3,a.Amplitude_SLamb3(p)*1e9*a.uSumBShear3{p},'LineWidth',.5,'Color',a.LineColors3(LineColorsIndex,:))
        ...
        h5 = axes('Parent',Tab3,'Units','pixels','Position',[340 450 800 120]);
        line(a.PlotXAxis3,uSUM*1e9,'LineWidth',.5,'Color',[.13 .55 .131])
        xline(a.Gate3(1))
        xline(a.Gate3(2))
        h5.Box = 'on';
        h5.XLabel.String = ['Propagation time (',char(181),'s)'];
        ...
        elseif a.DataType3 == 2
            if  a.Symmetric
                if  ~a.Decoupled
                    if  any(~cellfun(@isempty,a.uSumA3))
                        for p = 1:length(a.PhaseVelocityA3)
                            if  a.Plot_ALamb3(1) == 1 && ~isempty(a.uSumA3{1})
                                FrequencyLimitLow = 0;
                                break
                            elseif a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumA3{p}) && a.A{p}(1,1) < FrequencyLimitLow
                                FrequencyLimitLow = a.A{p}(1,1);
                                break
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumS3)) && FrequencyLimitLow > 0
                        for p = 1:length(a.PhaseVelocityS3)
                            if  (a.Plot_SLamb3(1) == 1 && ~isempty(a.uSumS3{1})) || (a.Plot_SLamb3(2) == 1 && ~isempty(a.uSumS3{2}))
                                FrequencyLimitLow = 0;
                                break
                            elseif a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumS3{p}) &&  a.S{p}(1,1) < FrequencyLimitLow
                                FrequencyLimitLow =  a.S{p}(1,1);
                                break
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumA3))
                        for p = 1:length(a.PhaseVelocityA3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumA3{p}) && a.A{p}(end,1) > FrequencyLimitHigh
                                FrequencyLimitHigh = a.A{p}(end,1);
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumS3)) && FrequencyLimitHigh < a.FrequencyLimit2
                        for p = 1:length(a.PhaseVelocityS3)
                            if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumS3{p}) && a.S{p}(end,1) > FrequencyLimitHigh
                                FrequencyLimitHigh = a.S{p}(end,1);
                            end
                        end
                    end
                else
                ...
                if  ~a.Decoupled
                    if  any(~cellfun(@isempty,a.uSumB3))
                        for p = 1:length(a.PhaseVelocityB3)
                            if  (a.Plot_ALamb3(1) == 1 && ~isempty(a.uSumB3{1})) || (a.Plot_ALamb3(2) == 1 && ~isempty(a.uSumB3{2})) || (a.Plot_ALamb3(3) == 1 && ~isempty(a.uSumB3{3}))
                                FrequencyLimitLow = 0;
                                break
                            elseif a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumB3{p}) && a.B{p}(1,1) < FrequencyLimitLow
                                FrequencyLimitLow = a.B{p}(1,1);
                                break
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumB3))
                        for p = 1:length(a.PhaseVelocityB3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumB3{p}) && a.B{p}(end,1) > FrequencyLimitHigh
                                FrequencyLimitHigh = a.B{p}(end,1);
                            end
                        end
                    end
                else
                    if  any(~cellfun(@isempty,a.uSumBLamb3))
                        for p = 1:length(a.PhaseVelocityBLamb3)
                            if  (a.Plot_ALamb3(1) == 1 && ~isempty(a.uSumBLamb3{1})) || (a.Plot_ALamb3(2) == 1 && ~isempty(a.uSumBLamb3{2}))
                                FrequencyLimitLow = 0;
                                break
                            elseif a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumBLamb3{p}) && a.BLamb{p}(1,1) < FrequencyLimitLow
                                FrequencyLimitLow = a.BLamb{p}(1,1);
                                break
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumBShear3)) && FrequencyLimitLow > 0
                        for p = 1:length(a.PhaseVelocityBShear3)
                            if  a.Plot_SLamb3(1) == 1 && ~isempty(a.uSumBShear3{1})
                                FrequencyLimitLow = 0;
                                break
                            elseif a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumBShear3{p}) && a.BShear{p}(1,1) < FrequencyLimitLow
                                FrequencyLimitLow = a.BShear{p}(1,1);
                                break
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumBLamb3))
                        for p = 1:length(a.PhaseVelocityBLamb3)
                            if  a.Plot_ALamb3(p) == 1 && ~isempty(a.uSumBLamb3{p}) && a.BLamb{p}(end,1) > FrequencyLimitHigh
                                FrequencyLimitHigh = a.BLamb{p}(end,1);
                            end
                        end
                    end
                    if  any(~cellfun(@isempty,a.uSumBShear3)) && FrequencyLimitHigh < a.FrequencyLimit2
                        for p = 1:length(a.PhaseVelocityBShear3)
                            if  a.Plot_SLamb3(p) == 1 && ~isempty(a.uSumBShear3{p}) && a.BShear{p}(end,1) > FrequencyLimitHigh
                                FrequencyLimitHigh = a.BShear{p}(end,1);
                            end
                        end
                    end
                end
        ...
        h4 = axes('Parent',Tab3,'Units','pixels','Position',[740 230 400 170]);
        hold on
        line(a.FrequencyRange3,PropagatedMagnitude*1e9,'LineWidth',.5,'Color',[.13 .55 .131])
        h4.Box = 'on';
        h4.TitleFontWeight = 'normal';
        h4.Title.String = 'Propagated spectrum'; 
        h4.XLabel.String = 'Frequency (kHz)';
