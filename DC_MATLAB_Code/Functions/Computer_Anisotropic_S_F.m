...
% =========================================================================
function S = Computer_Anisotropic_S_F(Multithreading,Q1,Q2,ax,Viscoelastic,FluidLoading,Fluid,FluidDensityThreshold,Material,FrequencyRange,PlateThickness,HigherOrderModes,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,Delta,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset)
...
if  HigherOrderModes && any(H)
    ...
    for p = 1:length(H)
        if  ~Multithreading
            [S,X1,MissingModes] = Computer_Anisotropic_S_F_HigherModes(Multithreading,Q1,Q2,FluidLoading,Fluid,Material,FrequencyRange,PlateThickness,H,FrequencyResolution,PhaseVelocityLimit,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,MissingSamples,BelowCutoffWidth,PhaseVelocityStep,FrequencyOffset,S,X1,MissingModes,X0,T,p,g,g1,a11,a12,a21,a22,a23,a31,a32,a33,a34);
            clear Computer_Anisotropic_S_F_HigherModes
        else
            X = [];
            Misses = 0;
            BelowCutoff = 0;
