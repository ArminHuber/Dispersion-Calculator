...
% =========================================================================
function SScholte = Computer_Anisotropic_SScholte_Coupled_V(Multithreading,Q,ax,Fluid,Material,FrequencyRange,PlateThickness,HigherOrderModes,H,FrequencyResolution,Resolution,SearchWidthReal,SearchWidthImag,SearchAreaSections,SearchAreaExtensions,c,SuperLayerSize,LayerThicknesses,Repetitions,Delta,MissingSamples,BelowCutoffWidth)        
if  Resolution > 1e-6
    Resolution = 1e-6;
end
