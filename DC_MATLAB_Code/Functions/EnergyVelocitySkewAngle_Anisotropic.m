...
function output_txt = Cursor(~,event_obj)
    ...
    elseif XAxisMode == 3 && length(event_obj.Target.XData) ~= 2
        output_txt = {['\textbf{',ModeName,'}'] ['$f\cdot d$: \textbf{',num2str(event_obj.Position(1),6),'} MHz$\cdot$mm'] ['$\gamma$: \textbf{',num2str(event_obj.Position(2),6),'}\,$^\circ$']};
