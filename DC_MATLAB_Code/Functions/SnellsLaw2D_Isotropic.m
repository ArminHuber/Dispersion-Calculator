...
% =========================================================================
function SnellsLaw2D_Isotropic(Crop,Export,PDF,PNG,FileName,Directory,HeadLine,GuideLines,SlownessLineWidth,FontSizeHeadLine,FontSizeAxes,FontSizeAxesLabels,BulkWaves,FontSizeModeLabels,WaveVectorLineWidth,PNGresolution,X,Y,Fluid,Solid,Theta)
...
elseif HeadLine == 1
    ...
    ax.Title.String = ['Bulk waves in ',char(join(split(Solid.Name,'_'),'\_')),' @ $\theta$ = ',num2str(Theta),'\,$^{\circ}$'];
end
z = ax.RTick;
z(1) = '';
ax.RTick = z;
